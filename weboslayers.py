...
('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=f091a05', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=bc9268d', ''),
]
