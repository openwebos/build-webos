...
('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=a11f27d', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=0a4ded8', ''),
]
