...
('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=5998b9f', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=2822087', ''),
]
