...
('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=4c67a9c', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=12dad4a', ''),
]
