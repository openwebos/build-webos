...
('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=687c409', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=208fc94', ''),
]
