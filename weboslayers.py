...
('meta-webos-backports',   9, 'git://github.com/openwebos/meta-webos-backports.git',    'commit=7f21642', ''),
('meta-webos',            10, 'git://github.com/openwebos/meta-webos.git',              'commit=20b6fa5', ''),
]
